...
public class MoteurActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(R.string.menu_22);

        host = (TabHost)findViewById(R.id.tabHost);
        host.setup();

        //Tab 1
        TabHost.TabSpec spec = host.newTabSpec(this.getString(R.string.moteur_tab_1));
        spec.setContent(R.id.tab1);
        spec.setIndicator(this.getString(R.string.moteur_tab_1));
        host.addTab(spec);

        //Tab 2
        spec = host.newTabSpec(this.getString(R.string.moteur_tab_2));
        spec.setContent(R.id.tab2);
        spec.setIndicator(this.getString(R.string.moteur_tab_2));
        host.addTab(spec);
